...
![GitHub repo file or directory count](https://img.shields.io/github/directory-file-count/Tayra-Sakurai/Tango)
...
This application is released under the [GNU General Public License v3.0](./LICENSE.txt) or later.